...
model = dict(
    ...
    img_recons_proxy=dict(type='ReconstructionProxyNerf')
)
...
# trace_config # Copyright (c) Phigent Robotics. All rights reserved.
...
evaluation = dict(interval=1, pipeline=test_pipeline)
load_from="work_dirs/bevdet-occ-self/epoch_2.pth"
# fp16 = dict(loss_scale='dynamic')
# find_unused_parameters=True
# trace_config = dict(type='tb_trace', dir_name='work_dir')
# profiler_config = dict(on_trace_ready=trace_config)= dict(type='tb_trace', dir_name='work_dir')
