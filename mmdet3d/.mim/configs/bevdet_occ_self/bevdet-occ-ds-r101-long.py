...
bev_inchannels=numC_Trans * (len(range(*multi_adj_frame_id_cfg))+1) + 64
model = dict(
...
load_from="work_dirs/bevdet-occ-self-r101-long/epoch_state.pth"
