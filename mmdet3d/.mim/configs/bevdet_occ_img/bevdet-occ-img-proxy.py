...
model = dict(
    ...
    use_depth_back_proj=True,
    depth_back_projector=dict(type='VolumeProjector',
                              feat_out_dim=256),
    depth_decoder=dict(type='DepthDecoder',
                       depth_in_dim=256,
                       depth_out_dim=1,
                       out_scale=[0]),
    use_depth_sup=False,
    use_img_recons_proxy=True,
    img_recons_proxy=dict(type='ReconstructionProxy')
)
