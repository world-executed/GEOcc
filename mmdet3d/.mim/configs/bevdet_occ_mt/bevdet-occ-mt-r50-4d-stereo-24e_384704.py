...
# Data
dataset_type = 'NuScenesDatasetOccpancyOD'
...
train_pipeline = [
    ...
    dict(
        type='Collect3D', keys=['img_inputs', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_depth', 'voxel_semantics',
                                'mask_lidar','mask_camera']) # Add bboxes,labels
]
