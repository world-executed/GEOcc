...
model = dict(
    ...
    img_view_transformer=dict(
        type='LSSViewTransformerBEVStereoPreDepth',
...
train_pipeline = [
    ...
    dict(
        type='Collect3D', keys=['img_inputs', 'gt_depth', 'voxel_semantics',
                                'mask_lidar','mask_camera','cam_mask'])
]
    ...
    dict(
        ...
        transforms=[
            dict(
                ...
                with_label=False),
            dict(type='Collect3D', keys=['points', 'img_inputs','cam_mask'])
        ])
]
...
data = dict(
    ...
    train=dict(
        data_root=data_root,
        ann_file=data_root + 'bevdetv2-nuscenes_infos_train_mini.pkl',
