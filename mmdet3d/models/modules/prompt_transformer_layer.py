...
class PromptTransformerLayer(BaseModule):
    ...
    def __init__(self,
        ...
        super(PromptTransformerLayer, self).__init__(init_cfg)
...
class DINOEncoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(DINOEncoder, self).__init__(*args, **kwargs)
