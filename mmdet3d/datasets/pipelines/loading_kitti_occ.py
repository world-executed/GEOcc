...
class LoadSemKittiAnnotation():
    ...
    def __call__(self, results):
        ...
        # imgs, rots, trans, intrins, post_rots, post_trans, gt_depths, cam2lidars, poses
        imgs, rots, trans, intrins, post_rots, post_trans, gt_depths, cam2lidars, poses = results['img_inputs']
        
        # (imgs, sensor2egos, ego2globals, intrins, post_rots, post_trans, bda_rot)
        results['img_inputs'] = (imgs, cam2lidars, poses, intrins, post_rots, post_trans, bda_rot)
        # results['img_inputs'] = (imgs, rots, trans, intrins, post_rots, post_trans, bda_rot, gt_depths, cam2lidars, poses)
        results['gt_depth'] = gt_depths
        results['voxel_semantics'] = gt_occ.long()
        results['img_ori'] = None
