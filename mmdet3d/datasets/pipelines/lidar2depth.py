...
class CreateDepthFromLiDAR(object):
    ...
    def project_points(self, points, rots, trans, intrins, post_rots, post_trans):
        ...
        # index 0 means currunt frame
        trans = trans[0:1]
        rots = rots[0:1]
        intrins = intrins[0:1]
        post_rots = post_rots[0:1]
        post_trans = post_trans[0:1]
    ...
    def __call__(self, results):
        ...
        imgs, rots, trans, intrins, post_rots, post_trans, cam2lidars, poses= results['img_inputs']
        results['img_inputs'] = imgs, rots, trans, intrins, post_rots, post_trans, gt_depths, cam2lidars, poses
