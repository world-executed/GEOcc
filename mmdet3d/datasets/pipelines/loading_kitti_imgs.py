...
class LoadMultiViewImageFromFiles_SemanticKitti(object):
    ...
    def get_inputs(self, results, flip=None, scale=None):
        ...
        # global
        pose = torch.Tensor(results['poses'][0])
        ...
        for adj_info in results['adjacent']:
            filename_adj = adj_info["img_3_path"]
            ...
            # align sensor2ego ego2global
            lidar2cam = torch.Tensor(adj_info['T_velo_2_cam'])
            cam2lidar = lidar2cam.inverse()
            rot = cam2lidar[:3, :3]
            tran = cam2lidar[:3, 3]
            rots.append(rot)
            ...
            pose = torch.Tensor(adj_info['pose'])
            poses.append(pose)
        ...
        res = (imgs, rots, trans, intrins, post_rots, post_trans, cam2lidars, poses)
        #[img, rot, tran, intrin, post_rot, post_tran, depth, cam2lidar]
        return res
